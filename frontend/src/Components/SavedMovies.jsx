...
function SavedMovies() {
  ...
  return (
    <Container fluid className="text-white">
      ...
      <Row >
            <Col sm={3}>Poster</Col>
            <Col sm={3}><h3>Title</h3></Col>
            <Col sm={1}><p>Average Rating</p></Col>
            <Col sm={1}><p>My Rating</p></Col>
            <Col sm={3}><p>My Review</p></Col>
        </Row>
      {savedMoviesArray.map((oneMovie, i)=>{
        return <EachMovieSaved key={i} img={oneMovie.img} title={oneMovie.title} avgRating={oneMovie.avgRating} myRating={oneMovie.myRating} myReview={oneMovie.myReview}/>
      })}
    </Container>
  )
  }
